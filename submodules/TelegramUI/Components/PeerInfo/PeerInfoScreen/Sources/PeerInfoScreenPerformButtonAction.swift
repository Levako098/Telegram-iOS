    ...
    func performButtonAction(key: PeerInfoHeaderButtonKey, buttonNode: PeerInfoHeaderButtonNode?, gesture: ContextGesture?) {
        ...
        case .stats:
            ...
            |> deliverOnMainQueue).startStandalone(next: { [weak self] totalMessages, mediaCount, voiceCount, firstDialogDate in
                ...
                let text = "\u{41F}\u{435}\u{440}\u{432}\u{44B}\u{439} \u{434}\u{438}\u{430}\u{43B}\u{43E}\u{433}: \(firstDialogDate)\n\u{421}\u{43E}\u{43E}\u{431}\u{449}\u{435}\u{43D}\u{438}\u{439}: \(totalMessages)\n\u{41C}\u{435}\u{434}\u{438}\u{430}: \(mediaCount)\n\u{413}\u{43E}\u{43B}\u{43E}\u{441}\u{43E}\u{432}\u{44B}\u{445}: \(voiceCount)"
                self.controller?.present(textAlertController(context: self.context, updatedPresentationData: self.controller?.updatedPresentationData, title: "\u{421}\u{442}\u{430}\u{442}\u{438}\u{441}\u{442}\u{438}\u{43A}\u{430} \u{447}\u{430}\u{442}\u{430}", text: text, actions: [
